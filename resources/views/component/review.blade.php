...
<section class="page-banner">
    ...
    <section>
        <div class="auto-container mt-5">
            <div class="row">
                <div class="col-lg-12 text-center mb-2"> <h2>Customer Reviews</h2> </div> 
                <div class="col-lg-4">
                    <!-- one review card open -->
                    <div class="card">
                        <div class="card-body">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="content mb-5 mr-lg-5">
                        <div class="sec-title">
                            <div class="sub-title">Customer Reviews</div>
                            <h2>Got Update Customer Reviews ?</h2>
