                    ...
                    <div class="news-block-two blog-single-post">
                        <div class="inner-box">                            
                            <div class="lower-content">
                                ...
                                <div class="image"><a href="#"><img class="lazy-image owl-lazy" src="{{ asset('assets/images/resource/image-spacer-for-validation.png')}}" data-src="assets/images/resource/news-7.jpg" alt=""></a></div>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="image"><a href="#"><img class="lazy-image owl-lazy" src="{{ asset('assets/images/resource/image-spacer-for-validation.png')}}" data-src="assets/images/resource/news-8.jpg" alt=""></a></div>
                                    </div>
                                    <div class="col-md-7">
                                ...
                                <div class="related-post">
                                    ...
                                    <div class="row">
                                        <div class="news-block-five col-md-6">
                                            <div class="inner-box">
                                                <div class="image"><a href="#"><img class="lazy-image owl-lazy" src="{{ asset('assets/images/resource/image-spacer-for-validation.png')}}" data-src="assets/images/resource/news-10.jpg" alt=""></a></div>
                                                <div class="lower-content">
                                                    <ul class="post-meta">
                                        ...
                                        <div class="news-block-five col-md-6">
                                            <div class="inner-box">
                                                <div class="image"><a href="#"><img class="lazy-image owl-lazy" src="{{ asset('assets/images/resource/image-spacer-for-validation.png')}}" data-src="assets/images/resource/news-11.jpg" alt=""></a></div>
                                                <div class="lower-content">
                                                    <ul class="post-meta">
                                                        <li><a href="#"><i class="far fa-calendar-alt"></i>24th March 2020</a></li>
                                                    </ul>
                    ...
                    <aside class="sidebar">
                        ...
                        <div class="sidebar-widget popular-posts">
                            ...
                            <div class="widget-content">
                                ...
                                <!--News Post-->
                                <div class="news-post">
                                    <div class="post-thumb"><a href="blog-details.html"><img class="lazy-image loaded" src="{{ asset('assets/images/resource/image-spacer-for-validation.png')}}" data-src="assets/images/resource/thumb-8.jpg" alt=""></a></div>
                                ...
                                <!--News Post-->
                                <div class="news-post">
                                    <div class="post-thumb"><a href="blog-details.html"><img class="lazy-image loaded" src="{{ asset('assets/images/resource/image-spacer-for-validation.png')}}" data-src="assets/images/resource/thumb-9.jpg" alt=""></a></div>
                                    <div class="date"><span class="fa fa-calendar-alt"></span> Feb 20, 2020</div>
                                    <h4><a href="blog-details.html">Lorem ipsum dolor sit <br>cing elit, sed do.</a></h4>
                                </div>
                                <!--News Post-->
                                <div class="news-post">
                                    <div class="post-thumb"><a href="blog-details.html"><img class="lazy-image loaded" src="{{ asset('assets/images/resource/image-spacer-for-validation.png')}}" data-src="assets/images/resource/thumb-10.jpg" alt=""></a></div>
                                    <div class="date"><span class="fa fa-calendar-alt"></span> Feb 14, 2020</div>
                                    <h4><a href="blog-details.html">Lorem ipsum dolor sit <br> cing elit, sed do.</a></h4>
                                </div>
                                <!--News Post-->
                                <div class="news-post">
                                    <div class="post-thumb"><a href="blog-details.html"><img class="lazy-image loaded" src="{{ asset('assets/images/resource/image-spacer-for-validation.png')}}" data-src="assets/images/resource/thumb-11.jpg" alt=""></a></div>
                                    <div class="date"><span class="fa fa-calendar-alt"></span> Feb 14, 2020</div>
                                    <h4><a href="blog-details.html">Lorem ipsum dolor sit <br> cing elit, sed do.</a></h4>
                                </div>
                            </div>
