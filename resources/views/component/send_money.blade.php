            ...
            <div class="row">
                    ...
                    <aside class="sidebar">
                        ...
                        <div class="sidebar-widget-two categories-widget-two">
                            <div class="widget-content">
                                <ul>
                                    <li><a href="services-details.html">Financial Planning <i class="fa fa-angle-right"></i></a></li>
                                    <li class="current"><a href="services-details.html">Software & Research <i class="fa fa-angle-right"></i></a></li>
                                    <li><a href="services-details.html">Business Services <i class="fa fa-angle-right"></i></a></li>
                                    <li><a href="services-details.html">Quality Resourcing <i class="fa fa-angle-right"></i></a></li>
                                    <li><a href="services-details.html">Travel and Aviation <i class="fa fa-angle-right"></i></a></li>
                                    <li><a href="services-details.html">Healthcare Services <i class="fa fa-angle-right"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <!-- Contact Form Widget -->
                        ...
                        <div class="sidebar-widget-two contact-info-widget">
                            <div class="inner-box" style="background-image: url(assets/images/background/image-18.jpg);">
                                ...
                                <ul>
                                    ...
                                    <li><a href="tel:+98787676576">+987 876 765 76</a></li>
                ...
                <div class="col-lg-8">
                    <div class="services-details pl-lg-5">
                        <div class="image-box"><img src="{{ asset('assets/images/resource/service-1.jpg')}}" alt=""></div>
                        <div class="content">
                            <div class="sec-title">
                        ...
                        <div class="graph">
                            <div class="row">
                                <div class="col-md-8">
                                    <img src="{{ asset('assets/images/resource/graph-2.png')}}" alt="">
                                </div>
                                <div class="col-md-4">
                                    <div class="progress-block">
                                        <div class="inner-box">
                                            <div class="graph-outer">
                                                <input type="text" class="dial" data-fgColor="#c23028" data-bgColor="#db846300" data-width="210" data-height="210" data-linecap="normal"  value="80">
                        ...
                        <div class="loan-calculator">
                            ...
                            <div class="progress-bar-outer">
                                <div class="progress-box">
                                    <div class="bar">
                                        <div class="bar-inner count-bar" data-percent="64%"><div class="count-text"></div></div>
                                    </div>
                                ...
                                <div class="progress-box">
                                    <div class="bar">
                                        <div class="bar-inner count-bar" data-percent="34%"><div class="count-text"></div></div>
                                    </div>
                                    <div class="row m-0 justify-content-between">
                                ...
                                <div class="progress-box">
                                    <div class="bar">
                                        <div class="bar-inner count-bar" data-percent="84%"><div class="count-text"></div></div>
                                    </div>
                                    <div class="row m-0 justify-content-between">
